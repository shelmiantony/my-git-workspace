  ...
  return (
    <Container>
      <Paper>
        ...
        <Box className='flex flex-col items-center md:w-1/2 lg:pr-24 md:pr-16 mb16 md:mb-0 '>
<Card style={{ padding: '20px', backgroundColor: '#F4ECE6',width:'500px' }}>
<CardContent className='flex flex-col items-center'>
<img src={Profile} alt='Profile' className='w-32 h-32 mb-4 rounded-full' />
              <Typography variant='h4' component='h1' className='text-black font-bold underline-offset-4 mb-2'>
             Shelmi K A
              </Typography>
              <Typography variant='h8' component='h3' className='text-black font-thin mb-2'>
           React.Js Developer
              </Typography>
              <Box className='flex justify-center space-x-4 mb-4 pt-11'>
                <IconButton href='https://www.linkedin.com' target='_blank' className='text-black'>
                  <LinkedIn />
                </IconButton>
                <IconButton href='https://github.com' target='_blank' className='text-black'>
                  <GitHub />
                </IconButton>
                <IconButton href='https://twitter.com' target='_blank' className='text-black'>
                  <Twitter />
                </IconButton>
                </Box>
</CardContent>
          ...
          <Grid item md={6} xs={12}>
            <Box className='flex-grow flex flex-col items-center md:items-start text-center md:text-left'>
              <Typography variant='h2' component='h1' className='mb-4 font-medium text-gray-900'>
                Hello
              </Typography>
              <Typography variant='h8'  className='mb-4 font-medium text-gray-900'>
